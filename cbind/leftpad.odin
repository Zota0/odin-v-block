...
foreign import lib "leftpad.lib"

@(default_calling_convention="c")
foreign lib {
    left_pad :: proc(str: cstring, len: c.int, ch: c.char) -> cstring ---
}

LeftPad :: proc(str: string, length: i32, ch: string) -> string {
    if len(ch) == 0 {
        return str
    }
    ...
    // Call the C function
    result := left_pad(c_str, c_len, c_ch)
